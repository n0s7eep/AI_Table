...
declare namespace UnionKey {
   ...
   */
  type LoginModule = 'pwd-login' | 'code-login' | 'register' | 'reset-pwd' | 'bind-wechat' | 'no-login';
   ...
   */
  type ThemeScrollMode = import('@aitable/materials').LayoutScrollMode;
   ...
   * - button: button style
   */
  type ThemeTabMode = import('@aitable/materials').PageTabMode;
