declare namespace NaiveUI {
  ...
  type TableColumnCheck = import('@aitable/hooks').TableColumnCheck;
  type TableDataWithIndex<T> = import('@aitable/hooks').TableDataWithIndex<T>;
  type FlatResponseData<T> = import('@aitable/axios').FlatResponseData<T>;
  ...
  type NaiveTableConfig<A extends TableApiFn> = Pick<
    import('@aitable/hooks').TableConfig<A, GetTableData<A>, TableColumn<TableDataWithIndex<GetTableData<A>>>>,
